...
public class easybuyProduct implements Serializable {
    ...
    public easybuyProduct(String name, String description, double price, int stock, int categoryLevel1, int categoryLevel2, String categoryLevel3, String fileName, int isDelete) {
        this.name = name;
        this.description = description;
        this.price = price;
        this.stock = stock;
